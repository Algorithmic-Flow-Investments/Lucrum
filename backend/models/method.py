...
class Method(db.Model):
	...
	substrings = db.relationship("MethodString", backref="parent", lazy='dynamic', cascade="delete", passive_deletes=True)
...
class MethodString(db.Model):
	...
	parent_id = db.Column(db.Integer, db.ForeignKey(Method.id, ondelete='CASCADE'))
